...
Once we have evaluated our policy, the next step is to improve it. As I mentioned in earlier, the policy improvement step is
...
I've talk about in the introduction: the **value iteration** algorithm.
